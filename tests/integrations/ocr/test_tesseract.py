...
@pytest.mark.asyncio
async def test_extract_returns_chunks_for_given_document_id(mocker):
...
@pytest.mark.asyncio
async def test_extract_mints_document_id_when_not_provided(mocker):
...
@pytest.mark.asyncio
async def test_extract_applies_min_confidence_from_config(mocker):
