...
## Current state (as of 2026-07-26, reranking migrated off LangChain to native vendor SDKs/REST and gained a shared `_base.py::NativeReranker`; reranking and translation gained sync+async method pairs (`rerank`/`arerank`, `translate`/`atranslate`), matching the pairing llm/embeddings/vad already had; translation gained a shared `_base.py::NativeTranslator`)
