...
## Current state (as of 2026-07-26, llm/embeddings/vector_store migrated off LangChain to native vendor SDKs; llm/embeddings gained a native shared `_base.py` per domain to remove cross-provider boilerplate)
