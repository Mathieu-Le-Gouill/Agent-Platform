...
from agent_platform.core.interfaces.vad.base import BaseVAD, ConfigT, CredentialsT
...
class FrameBasedVAD(BaseVAD[CredentialsT, ConfigT], Generic[CredentialsT, ConfigT]):
    def _on_speech(
        self,
        state: VADState,
        chunk: AudioChunk,
