...
class GMMConfig(ClusteringConfig):
    ...
    covariance_type: Literal["full", "tied", "diag", "spherical"] = "full"  # constraint on the shape of each component's covariance matrix
    ...
    init_params: Literal["kmeans", "k-means++", "random", "random_from_data"] = "kmeans"  # method used to initialize component weights, means, and covariances
