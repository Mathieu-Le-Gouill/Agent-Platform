...
class OpenAIWhisperConfig(SpeechConfig):
    model: str = "whisper-1"  # transcription model id, e.g. "whisper-1", "gpt-4o-transcribe"
    language: str | None = None  # ISO-639-1 language code; None lets the model auto-detect
    temperature: float = 0.0  # sampling temperature; higher values increase output randomness
    ...
    prompt: str | None = None  # optional text to bias/guide the model's style or vocabulary
