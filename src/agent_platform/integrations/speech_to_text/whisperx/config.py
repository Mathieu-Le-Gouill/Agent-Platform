...
class WhisperXConfig(SpeechConfig):
    ...
    align: bool = True  # runs phoneme-level forced alignment for accurate word timestamps
    diarize: bool = False  # runs speaker diarization to tag words with speaker labels
    hf_token: str | None = None  # HuggingFace access token required for diarization/alignment models
