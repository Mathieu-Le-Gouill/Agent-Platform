...
class DeepgramConfig(SpeechConfig):
    ...
    smart_format: bool = True  # applies punctuation/casing/formatting, see smart-format doc
    language: str | None = None  # BCP-47 language code; None lets Deepgram auto-detect, see language doc
