...
class OllamaLLM(BaseLLMProvider[OllamaGenerationConfig]):
    ...
    def generate(
        ...
        with traced_operation_span(
            "chat",
            **{
                GenAIAttributes.PROVIDER_NAME: "ollama",
            ...
            response = client.chat(model=config.model, messages=messages, **params)
