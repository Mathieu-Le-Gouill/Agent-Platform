...
class AzureTranslatorConfig(TranslationConfig):
    ...
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — forwarded via TranslateInputItem.text_type
    text_type: Literal["plain", "html"] | None = None
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — Custom Translator
    ...
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — forwarded via TranslationTarget.profanity_action
    profanity_action: Literal["NoAction", "Marked", "Deleted"] | None = None
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — forwarded via TranslationTarget.profanity_marker
    profanity_marker: Literal["Asterisk", "Tag"] | None = None
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — response
    ...
    # https://learn.microsoft.com/azure/ai-services/translator/reference/v3/translate — forwarded via TranslationTarget.allow_fallback
